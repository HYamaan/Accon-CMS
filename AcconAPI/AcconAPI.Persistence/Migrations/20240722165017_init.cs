    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    FooterCopyRight = table.Column<string>(type: "text", nullable: true),
                    FooterAdress = table.Column<string>(type: "text", nullable: true),
                    FooterPhone = table.Column<string>(type: "text", nullable: true),
                    FooterWorkingHours = table.Column<string>(type: "text", nullable: true),
                    FooterAboutUs = table.Column<string>(type: "text", nullable: true),
                    TopBarEmail = table.Column<string>(type: "text", nullable: true),
                    TopBarPhone = table.Column<string>(type: "text", nullable: true),
                    ContactMap = table.Column<string>(type: "text", nullable: true),
                    RecentPostCount = table.Column<int>(type: "integer", nullable: true),
                    PopularPostCount = table.Column<int>(type: "integer", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CounterBackgroundPhotoId = table.Column<Guid>(type: "uuid", nullable: true),
                    Counter1Text = table.Column<string>(type: "text", nullable: true),
                    Counter1Value = table.Column<string>(type: "text", nullable: true),
                    Counter2Text = table.Column<string>(type: "text", nullable: true),
                    Counter2Value = table.Column<string>(type: "text", nullable: true),
                    Counter3Text = table.Column<string>(type: "text", nullable: true),
                    Counter3Value = table.Column<string>(type: "text", nullable: true),
                    Counter4Text = table.Column<string>(type: "text", nullable: true),
                    Counter4Value = table.Column<string>(type: "text", nullable: true),
                    TotalRecentPosts = table.Column<int>(type: "integer", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HomePageSettings_ImageFiles_CounterBackgroundPhotoId",
                        column: x => x.CounterBackgroundPhotoId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GalleryPageId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommentShow = table.Column<bool>(type: "boolean", nullable: false),
                    IsPublished = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    MetaDescription = table.Column<string>(type: "text", nullable: false),
                    MetaKeywords = table.Column<string>(type: "text", nullable: false),
                    NewsPageId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HomePageSettings_CounterBackgroundPhotoId",
                table: "HomePageSettings",
                column: "CounterBackgroundPhotoId");
