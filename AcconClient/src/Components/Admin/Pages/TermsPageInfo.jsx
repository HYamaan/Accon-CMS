...
const TermsPageInfo = () => {
    ...
    useEffect(() => {
        const fetchPortfolioPageInfo = async () => {
            try {
                const response = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/Page/GetTermsPage`);
                if(response.data.succeeded) {
                    var data = response.data.data;
                    setTermsHeading(data.title);
    ...
    const handleSubmit =async () => {
        try {
            ...
            const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/Page/UpdateTermsPage`, data);
            if(response.data.succeeded) {
