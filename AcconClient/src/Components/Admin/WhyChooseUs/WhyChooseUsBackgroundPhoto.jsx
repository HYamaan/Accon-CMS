...
const WhyChooseUsMainPhoto = () => {
    ...
    useEffect(() => {
        const fetchSliders = async () => {
            try {
                const response = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/WhyChooseUs/GetBackgroundImage`);
    ...
    const handleSubmitLogo= async (e) => {
        ...
        try {
            const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/WhyChooseUs/UpdateBackgroundPhoto`, formData, {
                headers: {
